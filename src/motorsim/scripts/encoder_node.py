...
class EncoderNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Twist, "motor_speed", self.speed_callback, 10)
        self.motor_position_pub = self.create_publisher(Float64, "motor_position", 10)
    ...
    def speed_callback(self, msg:Twist):
        ...
        self.motor_position += msg.angular.z * delta_time
        self.last_time = current_time
        # self.get_logger().info(f"Current Position: {self.motor_position}")

    def timer_callback(self):
        msg = Float64()
        msg.data = self.motor_position
        self.motor_position_pub.publish(msg)
